...
class DPTHead(nn.Module):
    ...
    def _forward_impl(
        ...
        print('====baggregated_tokens_list',len(aggregated_tokens_list), [f.shape for f in aggregated_tokens_list])
        ...
        print('====before ffb', [o.shape for o in out])
        out = self.scratch_forward(out)
        print('====after ffb', out.shape, 'out_channels', self.out_channels)
